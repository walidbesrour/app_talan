...
class Intervention_List_VM: ViewModel {
    ...
    var arraylistmutablelivedata = MutableLiveData<ArrayList<Intervention_List_VM>>()
    var arraylist = ArrayList<Intervention_List_VM>()

    fun getArrayList() :MutableLiveData<ArrayList<Intervention_List_VM>>{

        arraylist.add(Intervention_List_VM(Intervention("1001","Fire Extinguisher xxz","ACTIVE",
                "1099","Fire OUI Extinguisher ","native","3","10/10/2021")))
        arraylist.add(Intervention_List_VM(Intervention("1105","Fire Extinguisher xxz","ACTIVE",
                "1589","Fire OUI Extinguisher ","hybride","2","25/7/1999")))
        arraylist.add(Intervention_List_VM(Intervention("2586","Fire Extinguisher xxz","ACTIVE",
