...
class Adapter_List_InterventionsFilles {
// (private val context: Context, private val list_Interventionsfilles: ArrayList<InterventionsAssocieesVM> ): RecyclerView.Adapter<Adapter_List_InterventionsFilles.Filles_Holder>()  {
//
//
